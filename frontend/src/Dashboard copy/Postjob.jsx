...
//     if (formData.hours <= 0 || formData.budget <= 0 || formData.workersNeeded <= 0) {
//       toast.error("Hours, budget and workers needed must be greater than 0 ❌");
//       setLoading(false);
//       return;
//     }
...
//           workersNeeded: formData.workersNeeded, // ✅ send workers
...
//       toast.error(err.response?.data?.error || "Job post failed ❌");
//     } finally {
//       setLoading(false);
//     }
//   };
